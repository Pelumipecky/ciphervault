...
export function Button({ 
  ...
  const variants = {
    primary: 'bg-accent text-background hover:bg-[#ffc800] shadow-md hover:shadow-lg',
    secondary: 'bg-surface text-text border border-border hover:border-accent/50',
    outline: 'bg-transparent text-text border-2 border-accent text-accent hover:bg-accent hover:text-background',
